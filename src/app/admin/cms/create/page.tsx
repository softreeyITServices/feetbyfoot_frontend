        ...
        <div style={styles.headerLeft}>
          ...
          <div style={styles.titleArea}>
            <p style={styles.breadcrumb}>
              CMS Content / {isEdit ? "Update" : "New Entry"}
            </p>
            <h1 style={styles.pageTitle}>
              {isEdit ? "Edit CMS Page" : "Create New Page"}
            </h1>
          </div>
        </div>
      ...
      <div style={styles.body}>
            ...
            <div style={styles.fieldGroup}>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  const selectedPage = PREDEFINED_PAGES.find(
                  ...
                  setForm((prev) => ({
                    ...
                    name: isEdit
                      ? prev.name
                      : selectedPage?.name || toPageName(selectedTitle),
                  }));
                }}
                style={styles.input}
                disabled={isEdit}
        ...
        <aside style={styles.sidebar}>
          <div style={styles.sideCard}>
            <p style={styles.sideTitle}>Actions</p>
            <button
