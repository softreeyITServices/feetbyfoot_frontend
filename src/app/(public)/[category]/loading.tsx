  ...
  return (
    <main className="w-full">
      ...
      <div className="text-center mt-10">
        <div className="inline-block bg-gray-200 animate-pulse h-12 w-56 rounded" />
        <div className="mt-2 bg-gray-200 animate-pulse h-4 w-72 mx-auto rounded" />
      </div>

      {/* Banner */}
      <section className="max-w-7xl mx-auto px-4 mt-6 mb-2">
        <div className="bg-gray-200 animate-pulse w-full h-48 rounded-2xl" />
      </section>
