...
export default function WorksOfArtPage() {
  return (
    <>
      <Navbar />
      <main className="bg-white">
        <div className="mx-auto max-w-[980px] px-4 py-10">
          ...
          <header className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-[780px] whitespace-pre-line text-[11px] leading-relaxed text-neutral-600">
          ...
          {/* ICON STATS — FIXED (React SVGs, no <img>) */}
          ...
          {/* Testimonial Collage (Figma-style, NO card border) */}
          <section className="mt-10 pb-10">
            {/* Desktop */}
            <div className="relative mx-auto hidden max-w-[980px] md:block">
              <div className="relative h-[260px]">
                {/* Left image */}
                <div className="absolute left-[120px] top-[10px] w-[260px] overflow-hidden">
                  <Image
                ...
                {/* Quote */}
                <div className="absolute left-1/2 top-[88px] w-[340px] -translate-x-1/2 text-center">
                  <p className="text-[13px] leading-relaxed text-emerald-700">
                    “Socks tends to consume everything else, it has become one’s
                    entire life.”
                  </p>

                  <div className="mx-auto mt-3 h-[2px] w-[78px] bg-emerald-500" />
                ...
                {/* Right image */}
                <div className="absolute right-[170px] bottom-0 w-[300px] overflow-hidden">
                  <Image
