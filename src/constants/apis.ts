...
export const PAYMENT_INTENT_URL = API_BASE_URL + "/payments/intent";
...
export const EX_REFRESH_TOKEN_URL = EXTERNAL_API_BASE_URL + "/auth/refresh";
...
export const EX_PAYMENT_INTENT_URL = API_BASE_URL + "/payments/intent";