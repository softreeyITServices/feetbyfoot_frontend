      ...
      {megaGroups.map((g) => {
        ...
        return (
          <div key={g.id} className="relative group">
            ...
            >
              <div className="bg-white border-t border-neutral-200 shadow-2xl w-full px-6 sm:px-12 py-8 sm:py-10 max-h-[70vh] overflow-y-auto">
                <div
                  className="grid gap-8 sm:gap-10 mx-auto max-w-7xl"
                  style={{
